...
"resource": {
  ...
  "macros":[{
      ...
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-M3HFT",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__u",
      ...
      "function":"__exs",
      "vtp_measurementId":"7_GVHu_OSsK3M0jCntgc4Q",
      "vtp_sections":["list",2]
    },{
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-M3HFT",
      "function":"__c",
      ...
      "function":"__c",
      "vtp_value":["map","",18697,"XhfwZ6mURw6jvzNOpEkr4w",0,"oFW-VKGpRm2LwpA7H255bg",18789,"7_GVHu_OSsK3M0jCntgc4Q",18763,"4pZZee16TzecyCCraUa49A",0,"T6sil_q_ToagWfLE1a8svg",0,"QjNbA513SD-mZCrwMjcefw",0,"H8AMQP6yR1G44kvLlKqNqA",18773,"WNdWTdcXSZyd2wBASeS86Q",0,"WEBdQSBLQf6nB8QNpvegCw",18789,"8Q4MaxXsQsmc_crVEB08dw",0,"9SAlHCnDQna0o0fJU1iYPA",0,"rhP1XZDRTQ2_YhjabTy7XQ",0]
    },{
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-TSKVG",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__exs",
      "vtp_measurementId":"H8AMQP6yR1G44kvLlKqNqA",
      "vtp_sections":["list",3]
    },{
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-TSKVG",
      "function":"__c",
      ...
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-KNLNB",
      "function":"__c",
      "vtp_value":true
    },{
      "vtp_component":1,
      ...
      "function":"__exs",
      "vtp_measurementId":"oFW-VKGpRm2LwpA7H255bg",
      "vtp_sections":["list",3]
    },{
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-KNLNB",
      "function":"__c",
      ...
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-TWCQM",
      "function":"__c",
      "vtp_value":true
    },{
      "function":"__exs",
      "vtp_measurementId":"WEBdQSBLQf6nB8QNpvegCw",
      "vtp_sections":["list",3]
    },{
      "vtp_experimentKey":"OPT-WTVWRNH_OPT-TWCQM",
      "function":"__c",
  ...
  "tags":[{
      ...
      "vtp_activate":true,
      "vtp_isEmpty":false,
      "vtp_treatmentId":"Experiment_OPT-WTVWRNH_OPT-TSKVG:0",
      "vtp_contextIndex":0,
      ...
      "function":"__est",
      "vtp_selector":"button.locator-ad__cta-container-button",
      "vtp_identifier":"button.locator-ad__cta-container-button",
  ...
  "predicates":[{
      ...
      "function":"_um",
      "arg0":["macro",3],
      "arg1":"https:\/\/www.allaboutvision.com"
    },{
      "function":"_eq",
      "arg0":["macro",18],
      "arg1":true
...
var li=function(a){if(ei[a]||gi)return;var b=G[ki()];Ca(b)&&(b("provide",a,Ba),ei[a]=!0);},ki=function(){return G.GoogleAnalyticsObject||"ga"},mi=function(a,b){return function(){var c=fi(),d=c&&c.getByName&&c.getByName(a);if(d){var e=d.get("sendHitTask");d.set("sendHitTask",function(f){var h=f.get("hitPayload"),k=f.get("hitCallback"),l=0>h.indexOf("&tid="+b);l&&(f.set("hitPayload",h.replace(/&tid=UA-[0-9]+-[0-9]+/,"&tid="+
...
m(a[2],{subcommand:a[1]})}if(3===a.length){D(39);var c=Ue(),d=a[1];"default"===d?(b(),Ld(a[2])):"update"===d&&(b(),Md(a[2],c))}},event:function(a){var b=a[1];if(!(2>a.length)&&g(b)){var c;if(2<a.length){if(!nb(a[2])&&void 0!=a[2]||3<a.length)return;c=a[2]}var d=Nl(b,c);return d}},get:function(a){},js:function(a){if(2==a.length&&a[1].getTime)return Ml=!0,Ol(),{event:"gtm.js","gtm.start":a[1].getTime()}},policy:function(){},set:function(a){var b;2==a.length&&nb(a[1])?b=m(a[1]):3==a.length&&g(a[1])&&(b={},nb(a[2])||Fa(a[2])?b[a[1]]=m(a[2]):b[a[1]]=a[2]);if(b){b._clear=!0;return b}}},Sl={policy:!0};var Tl=function(a,b){var c=a.hide;if(c&&void 0!==c[b]&&c.end){c[b]=!1;var d=!0,e;for(e in c)if(c.hasOwnProperty(e)&&!0===c[e]){d=!1;break}d&&(c.end(),c.end=null)}},Vl=function(a){var b=Ul(),c=b&&b.hide;c&&c.end&&(c[a]=!0)};
var dm=function(){try{var a,b;
var l,n=He.D,q=Rd('script[src*="gtm/js?id='+n+'"],script[src*="optimize.js?id='+n+'"]');l=q&&0<q.length?q[0]:null;b=l?l.hasAttribute("async")?"opta":"opts":"optu";b||(b="gaoo");var p=Xl(Yl,l&&l.src),r=p.Ob,u=p.Pb,t=p.Ac,v=p.Bc,x=p.uc,z=p.Fc,w=p.Ib,y=p.ud,A=p.Hb;"h0"!=w||Zl||(w="h3");$l={Ib:w,Hb:A,Tg:a,lh:b,ud:y,Bc:v,uc:x,Fc:z,Ac:t,Ob:r,Pb:u,af:am,
tf:bm};cm($l)}catch(B){console.log("[opttick] - "+He.D+": exception: "+B)}},em=function(){var a=G.gaData,b=0,c=void 0;if(a)for(var d in a)if(a.hasOwnProperty(d)&&0===d.indexOf("UA-")&&a[d].hitcount){b+=a[d].hitcount;var e=Number(a[d].first_hit);e&&(!c||e<c)&&(c=e)}return{cf:b,Ze:c}},Xl=function(a,b){var c,d,e,f,h,k,l,n,q;var p=G.performance;if(p){if(b){var r=p.getEntriesByName(b)[0];if(r){var u=p.getEntriesByType("resource"),t=0;u&&0<u.length&&
(t=u[0].startTime);f=Math.round(r.startTime-t);h=Math.round(r.duration);e=u.indexOf(r);-1===e&&(e=void 0);k=Math.round(a-(r.startTime+r.duration))}}var v=p.timing;if(v.domContentLoadedEventStart){var x=v.domContentLoadedEventStart-v.navigationStart;x&&(d=Math.round(a-x))}var z=p.getEntriesByType("paint").filter(function(B){return"first-contentful-paint"===B.name})[0];z&&(c=Math.round(a-z.startTime))}var w=G["dataLayer"].hide;if(w){if(void 0===w[He.D])l="h2";else{var y=!1;if(null===w.end)for(var A in w)if(w.hasOwnProperty(A)&&
A.startsWith(He.D)&&!0===w[A]){y=!0;break}l=y?"h0":"h1"}w.start&&!isNaN(w.start)&&(p?p.timing&&(q=Math.round(a+p.timing.navigationStart-w.start)):q=a-w.start);isNaN(w.timeout)||(n=w.timeout)}return{Ob:d,Pb:c,Ac:e,Bc:f,uc:h,Fc:k,Ib:l,ud:n,Hb:q}},cm=function(a,b){b=void 0===b?"ol":b;var c=function(e,f){null!=f&&(d+=e+encodeURIComponent(f))},d=Re;c("&t=",b);c("&s=",a.Ib);c("&h=",a.Hb);c("&g=",a.Tg);c("&p=",a.lh);c("&o=",a.ud);c("&l=",Pe?Wl-
Pa(Pe):void 0);c("&q=",a.Bc);c("&f=",a.uc);c("&e=",a.Fc);c("&i=",a.Ac);c("&d=",a.Ob);c("&c=",a.Pb);c("&tr=",a.Bh);c("&jl=",a.jh);c("&jf=",a.hh);c("&ji=",a.ih);c("&jq=",a.kh);c("&jd=",a.fh);c("&jx=",a.gh);c("&hc=",a.af);c("&fh=",a.tf);d+="&sr=0.050000";c("&ps=",fm);c("&cb=",Ja());jd(d);},gm=!1,Wl,Yl,Zl,fm,$l,am,bm;fm=Math.random(),gm="0.050000">fm;var jm=function(){
if(!gm||Wl)return;Wl=Xa();Yl=performance&&performance.now()||Wl;Zl=!!H.querySelector("body");var a=em(),b=a.Ze;am=a.cf;bm=b?Wl-b:void 0;Il(dm);},lm=function(a){var b=km;if(!gm)return;try{var c=Xa(),d=performance&&performance.now()||c,e=em(),f=e.cf,h=e.Ze,k=h?c-h:void 0;Il(function(){var l=Xl(d,b),n=l.Ob,q=l.Pb,p=l.Ac,r=l.Bc,u=l.uc,t=l.Fc,v=l.Ib,x=l.Hb,z=m($l||{});m(a,z);m({Ib:v,Hb:x,Ob:n,Pb:q,ih:p,kh:r,fh:u,gh:t,af:f,tf:k},z);cm(z,"od")})}catch(l){console.log("[odtick] - "+
He.D+": exception: "+l)}};var nm=function(a){if(mm(a))return a;this.m=a};nm.prototype.Xg=function(){return this.m};var mm=function(a){return!a||"object"!==kb(a)||nb(a)?!1:"getUntrustedUpdateValue"in a};nm.prototype.getUntrustedUpdateValue=nm.prototype.Xg;var om=[],pm=!1,qm=!1,rm=!1,sm=function(a){return G["dataLayer"].push(a)},tm=function(a){var b=L["dataLayer"],c=b?b.subscribers:1,d=0;return function(){++d===c&&a()}};
function um(a){var b=a._clear;Na(a,function(d,e){"_clear"!==d&&(b&&cf(d,void 0),cf(d,e))});Pe||(Pe=a["gtm.start"]);jm();var c=a["gtm.uniqueEventId"];if(!a.event)return!1;c||(c=Ue(),a["gtm.uniqueEventId"]=c,cf("gtm.uniqueEventId",c));return cj(a)}function vm(){var a=om[0];if(null==a||"object"!==typeof a)return!1;if(a.event)return!0;if(Oa(a)){var b=a[0];if("config"===b||"event"===b||"js"===b)return!0}return!1}
...
h[0];n&&fo(n,{hitType:"data"},!0,a)}}},mo=function(a){return!!a&&"G-"===a.substring(0,2)},no=function(a,b,c){mo(a)?nl("experiment_impression",{_experiment_id:b,_variant_id:c},a,!0):(ko(a,b,c),0<lo(a)&&io(a,{hitType:"data"},!0))};
var so=function(a,b,c){function d(){f||(f=!0,!0!==po&&(po=!1),qo(c),Tl(Ul(),e))}km=a;var e="GTM-WTVWRNH_"+b,f=!1;Vl(e);G.google_optimize=G.google_optimize||{};var h=G.google_optimize;h["GTM-WTVWRNH"]=h["GTM-WTVWRNH"]||{};h["GTM-WTVWRNH"].optimize_dyn=function(l){l.split(",").forEach(function(n){ro[n]=!0});po=!0;d()};gd(a,void 0,d);var k=Ul();G.setTimeout(function(){d()},Number(k&&k.hide&&k.hide.timeout)||1E4)},qo=function(a){if(void 0!==to){var b=to-uo,c,d;po?c=Xa()-to:d=Xa()-to;lm({Bh:b,jh:c,hh:d})}ro.optimize_ready=
!0;sm({event:"opt.dyn"});sm({event:"opt.js"});if(a&&0<a.length){var e={};Ul().forEach(function(f){var h=f.event;h&&(e[h]=!0)});a.forEach(function(f){e[f]&&sm({event:f})})}I(function(){li("_"+He.D)})},Ul=function(){return G["dataLayer"]},vo=function(a,b,c,d,e,f,h){function k(t,v){v&&(p+="&"+t+"="+encodeURIComponent(v))}uo=Xa();if(a||b||c){var l=void 0;if(b){var n=Ig().aw;n&&(l=n[0])}if(f&&(a||c||l)){var q=1,p,r="GTM-WTVWRNH_"+q++;Vl(r);var u=function(t){ho=t;to=Xa();a||b?(p="https://www.google-analytics.com/gtm/optimize-dyn.js?id=GTM-WTVWRNH",
a&&k("cid",t),k("gclid",l),h&&(k("gtm_auth",""),k("gtm_preview","")),(h||a)&&k("cb",String(Math.random())),so(p,q++,e)):qo(e);Tl(Ul(),r)};mo(d)?pl("client_id",u,d,!0):(co[d]=!0,eo(d,function(t){return u(t.get("clientId"))}))}else qo(e)}},ro={},uo,to,po,km;var wo=function(a,b){this.sc=a;this.Mb=b};wo.prototype.toString=function(){var a=""+this.sc;1<this.Mb&&(a=a+"-"+this.Mb);return a};var xo=function(a,b){this.o=a;this.m=b};xo.prototype.toString=function(){return this.m+"."+this.o};
var yo=function(){var a=$e("optimize.cookie_path",2);return g(a)?a:"/"},Ao=function(a,b){var c=new zo(a,b);c.oh();return c},zo=function(a,b){this.H=Math.floor(new Date/864E5);this.C=a||"auto";this.m=b||yo();this.o=new wo(Ef(this.C),Ff(this.m));this.F=[];this.map={}};aa=zo.prototype;aa.Wg=function(a){if(!a)return"";var b=this.rd(a);return b?b.o:""};aa.xh=function(a,b,c,d,e){var f,h;f=void 0===f?10:f;h=void 0===h?3E3:h;if(!a)return!1;void 0==b&&(b="");this.Dc(a,new xo(b,c));this.Bg(e);return this.ng(d,
f,h)};aa.rd=function(a){return this.map[a]};aa.Vg=function(){for(var a=0,b=0;b<this.F.length;b++)"x"!==this.rd(this.F[b]).o[0]&&a++;return a};aa.Dc=function(a,b){a&&(""===b.o?this.kf(a):(this.map[a]||this.F.push(a),this.map[a]=b))};aa.yh=function(a){for(var b=0;b<a.length;b++)this.Dc(a[b][0],a[b][1])};aa.kf=function(a){var b=Ga(this.F,a);0<=b&&this.F.splice(b,1);delete this.map[a]};aa.th=function(){for(var a=[],b=0;b<this.F.length;b++){var c=this.F[b];this.map[c].m<this.H&&a.push(c)}for(var d=0;d<
a.length;d++)this.kf(a[d])};aa.Ug=function(){for(var a=[],b=0;b<this.F.length;b++){var c=this.F[b];a.push([c,this.map[c]])}return a};aa.Pg=function(){for(var a=0,b=0;b<this.F.length;b++)a=Math.max(a,this.map[this.F[b]].m);return 864E5*a};aa.toString=function(){if(0==this.F.length)return"";for(var a=[],b=0;b<this.F.length;b++){var c=this.F[b];a.push(c+"."+this.map[c].toString())}return"GAX1."+this.o.toString()+"."+a.join("!")};aa.ng=function(a,b,c){var d=new Date;this.th();var e=this.Vg();if(e>b||
e>(a||10)&&document.cookie.replace(/(?:;\s*)?(_gaexp=[^;]+)(?:;\s*)?/,this.toString()).length>c)return!1;d.setTime(this.Pg());if("auto"!=this.C)return this.o=new wo(Ef(this.C),Ff(this.m)),0===Af("_gaexp",this.toString(),{path:this.m,domain:this.C,expires:d});for(var f=xf(),h=0;h<f.length;h++)if(this.o=new wo(Ef(f[h]),Ff(this.m)),0===Af("_gaexp",this.toString(),{path:this.m,domain:f[h],expires:d}))return!0;return!1};aa.oh=function(){var a=uf("_gaexp",this.o.sc,this.o.Mb);if(a){var b=this.ph(a);b&&
this.yh(b.Ug())}};aa.ph=function(a){for(var b=new zo(this.C,this.m),c=a.split("!"),d=0;d<c.length;d++){var e=c[d].split(".");if(3==e.length){if(isNaN(Number(e[1])))return;b.Dc(e[0],new xo(e[2],Number(e[1])))}}return b};aa.Bg=function(a){a=a||{};var b=0;a.hasOwnProperty("")&&!isNaN(Number(a[""]))&&(b=this.H-Pa(a[""]));for(var c=0;c<this.F.length;c++){var d=this.F[c];if(a.hasOwnProperty(d)&&!isNaN(Number(a[d]))){var e=this.rd(d);e.m=Pa(a[d])+b;this.Dc(d,e)}}};
var Fo=function(){Bo=Xa();var a=Co;Co=[];for(var b in a)a[b]();Do&&(Do.takeRecords(),Co.length||(Do&&(Do.disconnect(),Do=null),Eo&&(G.clearTimeout(Eo),Eo=null)))},Ho=function(){var a=Xa()-Bo;a>=Go?(Eo&&(G.clearTimeout(Eo),Eo=null),Fo()):Eo||(Eo=G.setTimeout(function(){Fo();Eo=null},Go-a))},Io=function(a){if(!G.MutationObserver)return!1;try{return Do||(Do=new MutationObserver(Ho),Do.observe(H.documentElement,{subtree:!0,childList:!0,attributes:!0,characterData:!0}),Bo=Xa()),Co.push(a),!0}catch(b){return!1}},
Do=null,Co=[],Go=0,Bo=0,Eo=null;
var Jo=function(a,b){b&&Io(a)||G.setTimeout(a,80)},Ko=function(a){try{return Rd(a)}catch(b){return null}},Lo=function(a){if(Kh)return!0;for(;a;){if(a.nextSibling)return!0;a=a.parentNode}return!1},Mo=function(a,b){for(var c=Ko(a.P)||[],d=[],e=0;e<c.length;e++){var f=c[e];if(!f.gtmProgressiveApplied||!f.gtmProgressiveApplied[b]){if(a.X&&!Lo(f))break;d.push(f)}}return d},No=function(a,b){return function(){a.gtmProgressiveApplied&&delete a.gtmProgressiveApplied[b]}},Oo=function(a,b){a.gtmProgressiveApplied||
(a.gtmProgressiveApplied={});a.gtmProgressiveApplied[b]=!0},Po=function(a,b,c){var d;var e=[];if(b.da)if(b.da.md)d=[{element:H.head}];else{var f=Mo(b.da,b.id),h=null;b.Ec&&(h=Mo(b.Ec,b.id+"-t"));for(var k=0;k<f.length;k++){var l=f[k],n=void 0;if(null!=h&&(n=h.length>k?h[k]:null,!n&&!Kh&&(null===b.Ec.O||b.Re+e.length<b.Ec.O)))break;e.push({element:l,Ah:n})}d=e}else d=e;var q=d;if(!Kh&&b.zg&&(!a||null==b.da.O||b.da.O!=b.nc+q.length))return!1;for(var p=0;p<q.length;p++){var r=q[p].element,u=q[p].Ah,
t=void 0;b.nc++;Oo(r,b.id);u&&(b.Re++,t=b.id+"-t",Oo(u,t));var v=b.Cg(r,u);Ca(v)&&b.ib.push(v);b.ib.push(No(r,b.id));u&&t&&b.ib.push(No(u,t))}if(b.da.O&&b.da.O==b.nc||Kh&&(!c||b.nc))b.finished=!0;return!0},Qo=function(a){for(var b={},c=0;c<a.ba.length;c++){var d=a.ba[c];if(!d.da.md){var e=b[d.da.P];e||(e=b[d.da.P]=Ko(d.da.P)||[]);for(var f=0;f<e.length;f++){var h=e[f];h.gtmProgressiveApplied&&h.gtmProgressiveApplied[d.id]||(Oo(h,d.id),d.ib.push(No(h,d.id)))}}}},Ro=function(a){if(!a.Hd){for(var b=
a.Gb;b<a.ba.length;b++){var c=a.ba[b],d=b==a.Gb;if(!c.finished&&!Po(d,c,a.vf&&a.uf))break;c.finished&&d&&a.Gb++}a.ba.length>a.Gb?(!a.pending&&a.vf&&(a.pending=!0,Jo(function(){a.pending=!1;Ro(a)},a.uf)),Kh||a.Bd||(a.Bd=function(){I(function(){Ro(a)})},kd(H,"DOMContentLoaded",a.Bd))):Qo(a)}},So={},To={},Uo=void 0,Vo=function(a,b,c,d){var e=Uo;if(!Qd||!e)return!1;var f={id:e.id+":"+e.ba.length,Cg:b,ib:[],zg:c,da:a,nc:0,Ec:d||null,Re:0,finished:!1};e.ba.push(f);null===a?(f.finished=!0,b(null)):Ro(e);
return!0},Wo=function(a){var b=Ba;try{b=vn(a,"visibility","hidden",!0)}catch(c){}return function(){Ca(b)&&b.apply();b=null}},Xo=function(a,b,c,d){var e=b;if(!Kh&&!a.md){var f=Wo(a.P);Mh.push(f);e=function(h,k){var l=b(h,k);f();return l}}return Vo(a,e,c,d)};function up(){return G.gaGlobal=G.gaGlobal||{}}var vp=function(){var a=up();a.hid=a.hid||Ja();return a.hid},wp=function(a,b){var c=up();if(void 0==c.vid||b&&!c.from_cookie)c.vid=a,c.from_cookie=b};var gq=window,hq=document,iq=function(a){var b=gq._gaUserPrefs;if(b&&b.ioo&&b.ioo()||a&&!0===gq["ga-disable-"+a])return!0;try{var c=gq.external;if(c&&c._gaUserPrefs&&"oo"==c._gaUserPrefs)return!0}catch(f){}for(var d=mf("AMP_TOKEN",String(hq.cookie),!0),e=0;e<d.length;e++)if("$OPT_OUT"==d[e])return!0;return hq.getElementById("__gaOptOutExtension")?!0:!1};var jq={};function lq(a){delete a.eventModel[C.yb];nq(a.eventModel)}var nq=function(a){Na(a,function(c){"_"===c.charAt(0)&&delete a[c]});var b=a[C.qa]||{};Na(b,function(c){"_"===c.charAt(0)&&delete b[c]})};var qq=function(a,b,c){nl(b,c,a)},rq=function(a,b,c){nl(b,c,a,!0)},xq=function(a,b){};
...
Z.g.exsu=["google"],function(){(function(a){Z.__exsu=a;Z.__exsu.h="exsu";Z.__exsu.i=!0;Z.__exsu.priorityOverride=0})(function(a){Ao(a.vtp_cookieDomain,a.vtp_cookiePath).xh(a.vtp_measurementId,a.vtp_newState,a.vtp_expirationDay,a.vtp_max,a.vtp_expirationDates)?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()})}();
...
Z.g.dr=["google"],function(){(function(a){Z.__dr=a;Z.__dr.h="dr";Z.__dr.i=!0;Z.__dr.priorityOverride=0})(function(a){var b=a.vtp_treatmentId,c=a.vtp_activate,d=a.vtp_contentSignature,e=a.vtp_isEmpty,f=Ym("optimize.experimentCallback",1),h=a.vtp_measurementId,k=a.vtp_experimentCombination,l=!!a.vtp_useMutationObserver,n=l?!!a.vtp_waitForElements:!0,q;if(q=c){var p=So[h];q=!(!p||p==b)}if(q)a.vtp_gtmOnFailure();else{var r=Ym("optimize.whitelist",1);if(r&&r[h]?r[h]===d:Dh()?e:1){if(Ca(f)){var u={xid:h,
xvar:k,activate:c};try{f(u)}catch(E){}}var t=!1,v=!0;if(c){var x;So[h]=b;var z=To[b];if(z){for(var w=z.Gb=0;w<z.ba.length;w++)z.ba[w].finished=!1;Ro(z);x=!0}else x=!1;if(x)t=!0;else{var y=To[b];y||(y={id:b,ba:[],Gb:0,pending:!1,Bd:void 0,Hd:!1,uf:l,vf:n},To[b]=y);Uo=y}}else{var A=To[b];if(!A||A.Hd)v=!1;else{for(;A.ba.length;)for(var B=A.ba.pop();B.ib.length;){var F=B.ib.pop();if(Ca(F))try{F()}catch(E){}}A.Hd=!0;delete To[b];v=!0}}v&&Un(h,c?k:void 0);a[t?"vtp_gtmOnFailure":"vtp_gtmOnSuccess"]()}else a.vtp_gtmOnFailure()}})}();
...
Z.g.asprv=["google"],function(){function a(){Zm({event:"optimize.domChange"});Io(a)}(function(b){Z.__asprv=b;Z.__asprv.h="asprv";Z.__asprv.i=!0;Z.__asprv.priorityOverride=0})(function(b){var c=b.vtp_globalName,d=!!b.vtp_listenForMutations,e=Ym("eventModel");c&&Rn(c);d&&a();var f,h,k;e&&(f=e.name||"",h=e.callback,k=e.remove);if(h&&Ca(h))if(f=String(f),!0!==k){var l=f,n=h;Sn(l).push(n);if(""!==l)void 0!==Qn[l]&&Tn(n,l,Qn[l]);else for(var q in Qn)void 0!==Qn[q]&&Tn(n,q,Qn[q])}else{var p=h,r=Sn(f),u=
...
Z.g.est=["customScripts"],function(){(function(a){Z.__est=a;Z.__est.h="est";Z.__est.i=!0;Z.__est.priorityOverride=0})(function(a){var b=a.vtp_property,c=a.vtp_value,d=a.vtp_important,e=a.vtp_selector,f=a.vtp_identifier,h=a.vtp_cssConditional;if(Qd)if(Uo){var k,l;if(a.vtp_cssRule){var n=vn(e,b,c,d,h);l=Vo({P:"body",X:!1,O:1},function(){Ca(n)&&n.apply();n=null;return vn(e,b,c,d,h)},!1)}else{var q={P:e,X:!1,O:e==f?1:null};k=function(p){if(p)return xn(p,b,c,d)};l=Xo(q,k,!1)}l?a.vtp_gtmOnSuccess():a.vtp_gtmOnFailure()}else a.vtp_gtmOnFailure();
...
864E5);}sm({event:"gtm.js"});Qe=(new Date).getTime();}}
